...
fn main() {
    ...
    let kernel_src = "kernel/sumcheck.cu";
    let cubin_path = out_dir.join("sumcheck.cubin");
    ...
    println!("cargo:rerun-if-changed=kernel/air_constraints.cuh");
    println!("cargo:rerun-if-changed=kernel/air_constraints_ext.cuh");
    println!("cargo:rerun-if-changed=kernel/air_ext_op.cuh");
    println!("cargo:rerun-if-changed=kernel/air_poseidon.cuh");
