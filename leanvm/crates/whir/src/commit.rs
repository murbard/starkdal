    ...
    PF<EF>: TwoAdicField,
{
    ...
    pub fn commit(
        ...
        // CPU DFT + GPU Merkle (best combo: CPU DFT is fast, GPU Merkle saves 300ms).
        // The GPU DFT chain was slower due to upload overhead at 2^24 scale.
        ...
        // MerkleData::build calls build_merkle_tree_koalabear which is
        // GPU-accelerated when the `gpu` feature is enabled.
